...
class modSEUP extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		*/
		...
		// --- P O D R Š K A  (sekcija) ---
		$this->menu[$r++] = array(
			'fk_menu'   => 'fk_mainmenu=seup',
			'type'      => 'left',
			'titre'     => 'Podrška',
			'mainmenu'  => 'seup',
			'leftmenu'  => 'seup_support',
			'url'       => '/custom/seup/index.php#support',
			'langs'     => 'seup@seup',
			'position'  => 1990,
			'enabled'   => '1',
			'perms'     => '1',
		...
		// Podrška → Kontaktiraj podršku
		$this->menu[$r++] = array(
			'fk_menu'   => 'fk_mainmenu=seup,fk_leftmenu=seup_support',
			'type'      => 'left',
			'titre'     => 'Kontaktiraj podršku',
			'mainmenu'  => 'seup',
			'leftmenu'  => 'seup_support_contact',
			'url'       => 'https://8core.hr/store/index.php?rp=/login',
			'langs'     => 'seup@seup',
			'position'  => 1991,
			'enabled'   => '1',
			'perms'     => '1',
		...
		// Podrška → Dokumentacija
		$this->menu[$r++] = array(
			'fk_menu'   => 'fk_mainmenu=seup,fk_leftmenu=seup_support',
			'type'      => 'left',
			'titre'     => 'Dokumentacija',
			'mainmenu'  => 'seup',
			'leftmenu'  => 'seup_support_docs',
			'url'       => 'https://dokumentacija.8core.hr/',
			'langs'     => 'seup@seup',
			'position'  => 1992,
			'enabled'   => '1',
			'perms'     => '1',
		...
		$this->menu[$r++] = array(
			...
			'mainmenu'  => 'seup',
			'leftmenu'  => 'seup_about',
			'url'       => '/custom/seup/admin/about.php',
			'langs'     => 'seup@seup',
			'position'  => 1999,
			'enabled'   => '1',
			'perms'     => '1',
